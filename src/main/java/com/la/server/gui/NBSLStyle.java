...
public class NBSLStyle {
    public static class COLOR {
        ...
        public static final Color SENSOR_INFO_BACKGROUND = new Color(60,63,65);
    ...
    public static class FONT {
        public static final Font PANEL_TITLE = new Font(
                "Microsoft YaHei UI", Font.BOLD, 16);
        public static final Font TEXT = new Font(
                "Microsoft YaHei UI", Font.PLAIN, 12);
    }
